...
class MLP:
    def __init__(self, evaluation_type="Leave-one-last", n_factors=256, learning_rate=0.0001, n_epochs=30, reg_lambda=1e-4, batch_size=2048, verbose=True):
    ...
    class MLPNet(torch.nn.Module):
        def __init__(self, n_factors, n_users, n_games):
            ...
            self.mlp = torch.nn.Sequential(
                torch.nn.Linear(n_factors * 2, 256),
                torch.nn.ReLU(),
